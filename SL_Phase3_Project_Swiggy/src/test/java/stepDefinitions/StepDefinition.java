...
public class StepDefinition {
	...
	public void the_user_enters_the_invalid_delivery_location_and_clicks_on_find_food_button(io.cucumber.datatable.DataTable dataTable) {
...
public void the_user_selects_the_entered_location_from_the_dropdown() {
	...
	WebElement loc_dropdown = driver.findElement(By.xpath("//span[text()='Sector 19, Noida, Uttar Pradesh, India']"));
	loc_dropdown.click(); 
...
public void verify_if_the_user_selected_location_is_displayed(DataTable dataTable) throws InterruptedException {
    ...
    WebElement locationField = driver.findElement(By.xpath("//span[text()=\" Noida, Uttar Pradesh 201301, India\"]")); 
...
public void The_user_clicks_on_the_search_result() {
	...
	WebElement restaurantName = driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/div[1]/div[2]/div/div/div[3]/div[1]/div/a"));
...
public void user_selects_a_product_and_clicks_on_add_button() {
	 ...
	 //WebElement product = driver.findElement(By.xpath("//h3[@class='styles_itemNameText__3ZmZZ' and contains(text(),'Classic Cold Coffee') ]"));
	 WebElement addProduct =driver.findElement(By.xpath("//*[@id=\"cid-BK_Cafe\"]/div[1]/div/div[15]/div[1]/div/div[2]/div[2]/div/div[1]"));
...
public void verify_that_product_is_added_to_cart_and_view_cart_icon_is_displayed() {
	 ...
	 WebElement viewCart =driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[1]/div/div/div[2]/div[23]/div[2]/button/span/span[2]/span"));
